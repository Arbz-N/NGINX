...
<body>
  <div class="container">
    <div class="header">
      ...
      <p>Built with Node.js & Modern UI</p>
    </div>
    ...
    <div class="footer">
      Made with ❤️ | API: <a href="/api/todos" style="color: #667eea; text-decoration: none;">GET /api/todos</a>
    </div>
  </div>
  ...
  <script>
    ...
    function updateUI() {
      ...
      document.getElementById('pendingCount').textContent = stats.total - stats.completed;
    }
