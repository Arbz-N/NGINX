NGINX Static Website – Setup Guide
  ...
  Creating a document root for your website
  Configuring NGINX with a custom server block
  Serving your page on a custom port (8080)
  Verifying the setup
...
Step 3 — Configure nginx.conf
  ...
  http {
      include mime.types;  # Required for proper linking of CSS
...
Congratulations!
  You have successfully hosted a static page using NGINX on your machine.
  Note: Read each file carefully before executing any command. This project is for learning and practice purposes. Remove test files when done:
